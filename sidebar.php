...
<ul>
  ...
  <div class="box">
    ...
    <a href="http://usfirst.org" title="Click here to go to FIRST's site"><img src="<?php bloginfo('url'); ?>/wp-content/themes/c0re/images/first.gif" alt="FIRST Robotics" /></a><br /><br />

    <p>We are part of <span>FIRST</span>, which stands for For Inspiration and Recognition of Science and 
Technology. <span>FIRST</span> is a not-for-profit organization dedicated to inspiring young people to pursue an 
education in Science &amp; Technology, while building confidence, knowledge, and life-skills. You can read more about <span>FIRST</span> at their site, or read more in our <span>FIRST</span> section.</p>
   ...
   <div class="box about-side">
    ...
    <a href="<?php bloginfo('url'); ?>/about/" rel="lightbox" title="A team portrait" ><img src="<?php bloginfo('url'); ?>/wp-content/themes/c0re/images/team.jpg" alt="Drivers &amp; Mentors at Competition"/></a><br /><br />
     ...
     <p><b>Team Name:</b> Marcus Corporation, GE Volunteers, Rockwell Automation, InSinkerator, Milwaukee School of 
Engineering, 
Cooper Power, Generac Power Systems, School District of Waukesha </p>
