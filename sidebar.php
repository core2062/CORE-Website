<div class="sidebar">
	<div class="box">
		...
		<a href="http://usfirst.org" title="Click here to go to FIRST's site">
			<img src="<?php bloginfo('url'); ?>/wp-content/themes/c0re/images/first.gif" alt="FIRST Robotics"/>
		</a>
		<br />
		<br />
	...
	<div class="box about-side">
		...
		<a href="<?php bloginfo('url'); ?>/about/" rel="lightbox" title="A team portrait" >
			<img src="<?php bloginfo('url'); ?>/wp-content/themes/c0re/images/team.jpg" alt="Drivers &amp; Mentors at Competition"/>
		</a>
		<br />
		<br />
