...
<div class="main-content">
	<?php if (have_posts()) : ?>
    	...
    	<div class="titleblock" title="<?php the_title(); ?> Article"><h3 id="post-<?php the_ID(); ?>"><a href="<?php the_permalink() ?>" rel="bookmark" title="Permanent Link to <?php the_title_attribute(); ?>"><?php the_title(); ?></a></h3></div>
